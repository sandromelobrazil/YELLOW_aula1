...
#####################################################################################
### ===> Funcao checkip ### ===> Funcao ler arquivo
### ===> Funcao execucao com 1 thread ### ===> Funcao execucao com multipl<as thread
...
def testa_ip(_address):
    if '/' in _address:
        try:
            ...
            lista_ip_testados.append(_address)
        except:
            pass
...
def func_main():
    ...
    portas = testaporta(option_args.ports)
